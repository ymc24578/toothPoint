...
// 72: 覆盖->得分
	...
	// 70: 覆盖->平面->合平面平行平面
	// 71: 覆盖->平面->交线
	// 72: 覆盖->平面->牙弓放射状相交平面->点
	// 73: 覆盖->平面->牙弓放射状相交平面->法向量
	// 74: 覆盖->平面->合平面平行平面->点
	// 75: 覆盖->平面->合平面平行平面->法向量
	// 76: 覆盖->平面->交线->点
	// 77: 覆盖->平面->交线->距离
...
private:
	...
	bool gapPointStat[5][2];
	double gapPointPosition[5][2][3];
	vtkSmartPointer<vtkActor> gapPointActor[5][2];
	int isGapPointShow;
	double gapProjecPointPosition[5][2][3];
	vtkSmartPointer<vtkActor> gapProjectPointActor[5][2];
	...
	// 颊侧区咬合
	//
	double faceSideVerticalScore, faceSideHorizonalScore;
	...
	vtkSmartPointer<vtkActor> topToothPointForVerticalPlaneActor[10], topToothProjectPointForVerticalPlaneActor[10];
	int isTopToothPointForVerticalPlaneShow, isTopToothProjectPointForVerticalPlane;

	// 上牙列水平向
	bool topToothPointForFitPlaneStat[10];
	double topToothPointForFitPlanePosition[10][3], topToothProjectPointForFitPlanePosition[10][3];
	vtkSmartPointer<vtkActor> topToothPointForFitPlaneActor[10], topToothProjectPointForFitPlaneActor[10];
	...
	*/
	...
	double aboPoints[5][2][3], aboArrangePointProjectToPlaneO[5][2][3], aboArrangePointProjectToFitPlanePoint[5][2][3];
	vtkSmartPointer<vtkActor> aboPointAcotor[5][2], aboArrangePointProjectToPlaneOAcotr[5][2], aboArrangePointProjectToFitPlane[5][2];
	int isAboArrangePointShow[5][2], isAboArrangeProjectPointShow[5][2];
	int aboArrangePointPickNum[5];
	double aboArrangePointPareDistance[5], aboArrangePointPareScore[5], aboArrangeScore;

	double aboArrangePlaneONormal[5][3];
	double aboArrangePlaneOCenter[5][3];
	double aboArrangePlaneOPoint[5][3][3]; // 0: origin
	vtkSmartPointer<vtkActor> aboArrangePlaneOActor[5], aboArrangePlaneOWireframeActor[5];
	int isAboArrangePlaneOShow[5];
	...
	double aboChapPoints[5][2][3], aboChapProjectPoint[5][2][3];
	vtkSmartPointer<vtkActor> aboChapPointAcotor[5][2], aboChapProjectPointAcotr[5][2];
	int isChapPointShow[5][2], isChapProjectPointShow[5][2];
	int aboChapPointPickNum[5];
	double aboChapPointPareDistance[5], aboChapPointPareScore[5], aboChapScore;
	//
	// ABO-OGS牙合关系
	//

	double aboToothCloseRelationPoints[5][2][3];
	vtkSmartPointer<vtkActor> aboToothCloseRelationPointAcotor[5][2];
	int isAboToothCloseRelationPointShow[5][2];
	int aboToothCloseRelationPointPickNum[5];
	double aboToothCloseRelationPointPlaneDistance[5], aboToothCloseRelationMeasureScore[5], aboToothCloseRelationScore;

	double aboToothCloseRelationPlaneONormal[5][3];
	double aboToothCloseRelationPlaneOCenter[5][3];
	double aboToothCloseRelationPlaneOPoint[5][3][3]; // 0: origin
	vtkSmartPointer<vtkActor> aboToothCloseRelationPlaneOActor[5], aboToothCloseRelationPlaneOWireframeActor[5];
	int isAboToothCloseRelationPlaneOShow[5];

	//
	// ABO-OGS牙合接触
	//

	double aboToothCloseTouchPoints[5][2][3];
	vtkSmartPointer<vtkActor> aboToothCloseTouchPointAcotor[5][2];
	int isAboToothCloseTouchPointShow[5][2];
	double aboToothCloseTouchMeasureDistance[5], aboToothCloseTouchMeasureScore[5], aboToothCloseTouchScore;

	double aboToothCloseTouchPlaneONormal[5][3];
	double aboToothCloseTouchPlaneOCenter[5][3];
	double aboToothCloseTouchPlaneOPoint[5][3][3]; // 0: origin
	vtkSmartPointer<vtkActor> aboToothCloseTouchPlaneOActor[5], aboToothCloseTouchPlaneOWireframeActor[5];
	int isAboToothCloseTouchPlaneOShow[5];

	vtkSmartPointer<vtkActor> aboToothCloseTouchTopIntersectCurveActor[5], aboToothCloseTouchLowIntersectCurveActor[5];
	int isAboToothCloseTouchIntersectCurveShow[5];

	//
	// ABO-OGS覆盖
	//

	double aboCoverPoints[5][2][3]; // 0: 上牙		1: 下牙
	vtkSmartPointer<vtkActor> aboCoverAcotor[5][2];
	int isAboCoverPointShow[5][2];
	double aboTCoverMeasureDistance[5], aboCoverMeasureScore[5], aboCoverScore;

	double aboCoverPlaneONormal[5][3];
	double aboCoverPlaneOCenter[5][3];
	double aboCoverPlaneOPoint[5][3][3]; // 0: origin
	vtkSmartPointer<vtkActor> aboCoverPlaneOActor[5], aboCoverPlaneOWireframeActor[5];
	int isAboCoverPlaneOShow[5];

	vtkSmartPointer<vtkActor> aboCoverIntersectCurveActor[5], aboCoverLowIntersectCurveActor[5];
	int isCoverIntersectCurveShow[5][2];

	//
	// ABO-OGS邻牙接触关系
	//

	double aboTouchRelationPoints[5][2][3], aboTouchRelationProjectPoints[5][2][3];
	vtkSmartPointer<vtkActor> aboTouchRelationPointAcotor[5][2], aboTouchRelationProjectPointAcotor[5][2];
	int isAboTouchRelationPointShow[5][2], isAboTouchRelationProjectPointShow[5][2];
	int aboTouchRelationPointNum[5];
	double aboTouchRelationMeasureDistance[5], aboTouchRelationMeasureScore[5], aboTouchRelationScore;
